...
Version:	0.1
Release:	1cisco%{?dist}
Summary:	Puppet Apache module

Group:		System Environment/Base
License: 	Apache License 2.0	
URL:		https://github.com/CiscoSystems/puppet-apache.git
Source0: 	%{name}-%{version}.tar.gz
BuildRoot:      %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)

%description
This module can be used to configure apache. It is recommended to use the openstack module as a starting place.
